...
if(request.getParameter("op")!=null&&request.getParameter("op").length()>0){
			...
			String strUrl = "jdbc:odbc:driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ="
				+ this.getServletContext().getRealPath("demodata/") + "\\demo_creword.mdb";
    ...
    <div class="zz-headBox br-5 clearfix" >
        <div class="zz-head mc">
            ...
            <ul class="head-rightUl fr">
                <li><a href="home.html">卓正网站</a></li>
                <li><a href="###">客户问吧</a></li>
                <li class="bor-0"><a href="contact-us.html">联系我们</a></li>
            </ul>
        </div>
    </div>
    <!--header end-->
        ...
        <div class="demo mc" style="text-align:left;">
            ...
            <table class="text" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;<a href="CreateWord.jsp" target="_blank"style=" color:Blue; text-decoration:underline;">新建文件</a>
                        </td>
                    <td style="width: 221px;">
                        &nbsp;&nbsp;
                    </td>
