...
function Init(num)
{
	...
	try{
		...
		document.form1.action="<%=basepath %>/otherProvinceAction_loginCheck.action";
...
<body onload="getMessage()" style="background:#fff url(images/ytbg_new.jpg) no-repeat left top;background-size:cover;-webkit-background-size: cover;-moz-background-size: cover;
