...
<script type="text/javascript">
	...
	function save()
	{
		if(check())
		{
			document.form1.action="<%=basepath %>/otherSkilledworkerAction_modified.action";
...
<div class="tit">
<img src="images/titico1.gif"/><strong>外省企业技术工人修改</strong>
            	...
            	<div class="list g2">
                	<table id="tb" width="100%" border="0" cellspacing="0" cellpadding="0" >
                      <tr>
                        ...
                        <td width="32%">
						<input id="cardId" type="text" maxlength='18' name="skilledworker.identityCard" value="<s:property value="skilledworker.identityCard"/>" class="ipu1" />
                      ...
                      <tr>
						...
						<select id="workType" name="skilledworker.skilledTypeNum" class="sel">
                        ...
                        <td>
						<input id="cer" type="text" maxlength='50' name="skilledworker.certificateNum" value="<s:property value="skilledworker.certificateNum"/>" class="ipu1" />
                        <span class="red">*</span>  </td>
                      </tr>
