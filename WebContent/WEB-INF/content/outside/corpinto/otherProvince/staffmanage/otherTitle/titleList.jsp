...
<script type="text/javascript">
	...
	function addTitle()
	{
		document.form1.action="<%=basepath%>/otherTitleAction_addPage.action";
		document.form1.submit();
	}
	...
	function goBack()
	{
		document.form1.action="<%=basepath%>/otherTitleAction_goBack.action";
		document.form1.submit();
	}
...
<body onload="getMessage()">
				...
				<tr>
					...
					<td valign="top">
						<div class="wr">
							...
							<div class="tit">
								<img src="images/titico2.gif" /><strong>外省企业职称人员搜索</strong>
							</div>
	...
	<div class="ry_liebiao">
		<p class="f16 pd10 fb">
			外省企业技术职称人员列表<img src="<%=basepath%>/images/ry_lie.png" />
		</p>
			...
			<tbody>
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<td><a
							href="otherTitleAction_modifyPage.action?personId=<s:property value="personId"/>"><span>修改</span></a>&nbsp;<a
							href="otherTitleAction_delete.action?personId=<s:property value="personId"/>"><span>删除</span></a></td>
