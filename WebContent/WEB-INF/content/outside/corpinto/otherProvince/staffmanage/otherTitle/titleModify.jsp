...
<script type="text/javascript">
	...
	function save()
	{
		if(check())
		{
			document.form1.action="<%=basepath %>/otherTitleAction_modify.action";
				...
				<form id="form1" name="form1" method="post" action="">
                	<table id="tb" width="100%" border="0" cellspacing="0" cellpadding="0" >
                      ...
                      <tr>
                        ...
                        <td>  
						<input id="cardId" type="text" maxlength='50' name="title.idCard" value="<s:property value="title.idCard"/>" class="ipu1"/>
						<span class="red">*</span>  </td>
                      </tr>
                      <tr>
