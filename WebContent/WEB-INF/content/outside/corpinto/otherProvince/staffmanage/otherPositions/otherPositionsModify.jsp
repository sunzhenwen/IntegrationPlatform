...
function verify()
{
    ...
    function checkCardId()
    {
		...
		{
			if(verify()){
        		document.form1.action="<%=basepath %>/otherPositionsAction_modified.action";
        		document.form1.submit();
            }
		}else
		{
...
<div class="tit"><img src="images/titico1.gif"/><strong>外省企业现场管理人员修改</strong>
				...
				<form id="form1" name="form1" method="post" action="">
                	<table id="tb" width="100%" border="0" cellspacing="0" cellpadding="0" >
                      <tr>
                        ...
                        <td width="32%">
						<input id="name" type="text" maxlength='50'  name="positions.name" value="<s:property value="positions.name"/>" class="ipu1" />
						<input type="hidden" name="positions.personId" value="<s:property value="positions.personId"/>"/>
						<span class="red">*</span> 
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                        <input id="cardId" type="text" maxlength='18'  name="positions.cardId" value="<s:property value="positions.cardId"/>" class="ipu1" />
						<input id="oldCardId" type="hidden" value="<s:property value="positions.cardId"/>" />
						<span class="red">*</span></td>
                      ...
                      <tr>
                        ...
                        <td>
                        <input id="cer" type="text" maxlength='50' name="positions.certNum" value="<s:property value="positions.certNum"/>" class="ipu1" />
						<span class="red">*</span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
