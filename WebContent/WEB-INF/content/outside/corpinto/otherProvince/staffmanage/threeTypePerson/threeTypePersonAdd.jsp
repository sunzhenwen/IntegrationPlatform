...
<script type="text/javascript">
	...
	function save()
	{
		if(check())
		{
			document.form1.action="<%=basepath %>/threeTypePersonAction_add.action";
...
<div class="tit"><img src="images/titico1.gif"/><strong>外省企业三类人员添加</strong><p>注：标记为（<span class="red">*</span>）的为必填项</p></div>
            <div class="main h384">
            	<div class="list g2">
