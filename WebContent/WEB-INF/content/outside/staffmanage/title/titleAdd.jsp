...
<input type="hidden" id="message" value="<s:property value="message" />" />
  ...
  <div class="head_a1">
    	...
    	<form id="form1" name="form1" method="post" action="<%=basepath %>/titleAction_add.action">
            ...
            <div class="ry_lbxx">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         <tr>
                         	<th>姓名：</th>
								<td><input type="text" maxlength='50'  name="title.personName" value="<s:property value="title.personName"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
								<input type="hidden" name="title.personId" value="<s:property value="title.personId"/>"/></td>
								<th>性别：</th>
								<td>
                         ...
                         <tr>
                         	<th>证件类型：</th>
								...
								<th>证件号码：</th>
								<td><input type="text" maxlength='50'  name="title.idCard" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                         </tr>
                           <tr>
                         	<th>职称：</th>
                         ...
                         <tr>
                           ...
                           <tr>
                         	<th>所学专业：</th>
								...
								<th>毕业时间：</th>
								<td><input id="time1" type="text" name="title.graduatedDate" value="<s:date name="title.graduatedDate" format="yyyy-MM-dd" />" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,isShowClear:true,readOnly:true})" class="required" /><strong><font color="#FF0000">*</font></strong></td>
