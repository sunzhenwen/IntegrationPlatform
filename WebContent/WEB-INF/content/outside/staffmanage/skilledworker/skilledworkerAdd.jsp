            ...
            <div class="ry_lbxx">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
						...
						<th>身份证号：</th>
                        <td align="left"><input type="text" maxlength='50'  name="skilledworker.identityCard" class="{required:true,digits:true}" /><strong><font color="#FF0000">*</font></strong></td>
                        </tr>
                          <!--
                         <tr>
                          ...
                          <th>性别：</th>
                            <td><select id="" name="skilledworker.sexNum" class="required">
							<option value="">请选择</option>
                          ...
                          -->
                           <tr>
                         	<th>工种类型：</th>
                            <td align="left"><select id="" name="skilledworker.skilledType" class="required">
							<option value="">请选择</option>
                            ...
                            <th>证书编号：</th>
                        	<td align="left"><input type="text" maxlength='50'  name="skilledworker.certificateNum" class="{required:true,digits:true}" /><strong><font color="#FF0000">*</font></strong></td>
                            <!-- 
                            <th>工种级别：</th>
                            <td><select id="" name="skilledworker.skilledLevel" class="required">
							<option value="">请选择</option>
                         ...
                         <tr>
                            ...
                            <th>手机号码：</th>
                            <td><input type="text" maxlength='50'  name="skilledworker.mobile" value="<s:property value="skilledworker.mobile"/>" class="required" /><strong><font color="#FF0000">*</font></strong></td>
                           
                         </tr>
                          
                           <tr>
                         	<th>学位：</th>
                            <td><select id="" name="skilledworker.degreeNum" class="required">
							<option value="">请选择</option>
                            ...
                            <th>学历：</th>
                            <td><select id="" name="skilledworker.eduLevelNum" class="required">
							<option value="">请选择</option>
