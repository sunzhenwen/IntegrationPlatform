	...
	<div class="ry_wrapp">
		...
		<div class="main">
					...
					<tr>
						...
						<td valign="top">
							<div class="wr">
								...
								<div class="tit">
									<img src="images/titico2.gif" /><strong>技术工人基本情况搜索</strong></div>
			...
			<div class="ry_liebiao">
				<p class="f16 pd10 fb">
					技术工人列表<img src="images/ry_lie.png" />
				</p>
					...
					<tbody>
						...
						<s:iterator status="i" value="currentPage.data">
							<tr>
								...
								<td><a
									href="skilledworkerAction_modifiedPage.action?personId=<s:property value="personId"/>">
										<span>修改</span>
								</a>&nbsp; <a
									href="skilledworkerAction_delete.action?personId=<s:property value="personId"/>">
										<span>删除</span>
								</a></td>
							</tr>
						</s:iterator>
