...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/designSurveyPrjsAction_queryPage.action";
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr>
                          	<td><input onclick="corpChoose(this.value)" type="radio" name="corpRadio" value="<s:property value="prjId"/>,<s:property value="prjNum"/>,<s:property value="prjName"/>,<s:property value="appDept"/>,<s:property value="appDeptName"/>"></td>
                          	<td><s:property value="#i.count"/> </td>
                            <td><s:property value="prjNum"/></td>
                            <td><s:property value="prjName"/></td>
                            <td><s:property value="allInvest"/></td>
                            <td><s:property value="allArea"/></td>
