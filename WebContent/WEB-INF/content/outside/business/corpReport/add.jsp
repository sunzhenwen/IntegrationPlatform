...
<body>
	...
	<form id="form1" name="form1" method="post" action="<%=basepath %>/corpReportAction_add.action">
        ...
        <div class="ry_content">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         <tr>
							...
							<input type="text" readonly name="corpReport.corpName" value="<s:property value="corpName"/>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input size="4" id="time3" value="<s:date name="corpReport.reportYear" format="yyyy" />" type="text" name="corpReport.reportYear" onFocus="WdatePicker({dateFmt:'yyyy',alwaysUseStartDate:true,isShowClear:true,readOnly:true})" class="required" />
                         ...
                         <tr>
							...
							<th>计量单位</th>
							<th colspan="2" align="left">自年初累计</th>
                         </tr>
                         <tr>
                        ...
                        <tr>
                          ...
                          单位负责人：<input type="text" maxlength='50' name="corpReport.legalMan" value="<s:property value="legalMan"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          联系电话：<input type="text" maxlength='50' name="corpReport.linkPhone" value="<s:property value="linkPhone"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
                          </td>
                        </tr>
                        <tr>
