	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">企业良好信息查询列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td><s:property value="certtypenum"/></td>
                             <td><s:property value="awardcontent"/></td>
							<td><s:property value="awarddate"/></td>
                             
                            <td>
                            	<a href="queryCredLhAction_queryPagee.action?goodcreditid=<s:property value="goodcreditid"/>"><span>详细</span></a>	
                         </tr>
						 </s:iterator>
