...
<script type="text/javascript">
	...
	function upload(id)
	{
		...
		if(uf!="")
		{
			...
			var actionUrl = "<%=basepath %>/fileUpload_uploadFile.action?id="+id+"&linkName=市建合同备案&returnRoot=theContractorSuccess";
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         ...
                         <tr>
                         	<th>标段名称：</th>
							<td colspan="4" align="left">
							<input id="sectionName" size="100" type="text" name="contractFiling.sectionName" value="<s:property value="contractFiling.sectionName"/>" />
                         ...
                         <tr>
							...
							<th>中标通知书编号：</th>
							<td align="left">
							<input id="tenderNum" readonly type="text" name="contractFiling.tenderNum" value="<s:property value="contractFiling.tenderNum"/>" />
							</td>
                         </tr>
                         <tr>
                         	<th>工程造价(万元)：</th>
							<td align="left">
							<input id="projectCost" type="text" name="contractFiling.projectCost" value="<s:property value="contractFiling.projectCost"/>"  />
							</td>
                         	<th>项目地址：</th>
							<td align="left">
                         ...
                         <tr>
							...
							<th>建筑面积：</th>
							<td align="left">
							<input id="area" type="text" name="contractFiling.area" value="<s:property value="contractFiling.area"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
...
<input id="safetyIdCard" type="hidden" name="contractFiling.safetyIdCard" value="<s:property value="contractFiling.safetyIdCard"/>" /><!-- 安全监理证件号码 -->							
						...
						<tr>
							...
							&nbsp;
							<input type="button" onclick="upload('<s:property value="contractFiling.recordId"/>')" value="上传" />
							</td>
						</tr>
						<tr>
                       		<th>附件：</th>
