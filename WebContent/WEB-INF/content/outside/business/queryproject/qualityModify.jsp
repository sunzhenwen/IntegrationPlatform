...
<script type="text/javascript">
	...
	function upload(id)
	{
		...
		if(uf!="")
		{
			...
			var actionUrl = "<%=basepath %>/fileUpload_uploadFile.action?id="+id+"&linkName=质量监督&isUnits=1&returnRoot=qualitySuccess";
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         ...
                         <tr>
							...
							<input id="prjName" type="text" size="112" readonly name="quality.prjName" value="<s:property value="quality.prjName"/>" class="required"/>
                         ...
                         <tr>
                           <th>合同名称：</th>
						   <td colspan="3" align="left">
								<input id="sectionName" type="text" size="112" name="quality.sectionName" value="<s:property value="quality.sectionName"/>" />
							</td>                       
                         </tr>
                         ...
                         <tr>							
							...
							<th>中标通知书编号：</th>
								<td align="left">
								<input id="tenderNum" readonly type="text" name="quality.tenderNum" value="<s:property value="quality.tenderNum"/>" />
							</td>						
                         </tr>
                         ...
                         <tr>
							...
							<input type="text"  name="quality.applyCorpName" size="112" value="<s:property value="quality.applyCorpName"/>" class="required"/>
							<strong><font color="#FF0000">*</font></strong>
							</td>
                         </tr>
                         <tr>
							<th>申请企业代码：</th>
							<td align="left" colspan="3">
								<input type="text"  name="quality.applyCorpCode" value="<s:property value="quality.applyCorpCode"/>" class="required"/>
								<strong><font color="#FF0000">*</font></strong>
                         ...
                         <tr>
							<th>质量监督编号：</th>
							<td align="left" colspan="3">
								<input type="text" size="112" readonly name="quality.qualityNum" value="<s:property value="quality.qualityNum"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
						 </tr>
                         ...
                         <tr>
                            <th>工程地点：</th>
							<td align="left" colspan="3">
							<input id="projectAddress" type="text" size="112" name="quality.projectAddress" value="<s:property value="quality.projectAddress"/>" class="required"/>
							<strong><font color="#FF0000">*</font></strong>
							</td>                        
                         </tr>                               
                         <tr>
                         ...
                         <tr>
                          ...
                          <tr>
                         	<th>建设单位：</th>
							<td colspan="3" align="left">
							<input id="developmentOrganization" type="text" size="112" name="quality.developmentOrganization" value="<s:property value="quality.developmentOrganization"/>" />
							</td>
                          </tr>
                          ...
                          <tr>
                         	<th>建设单位项目负责人：</th>
							<td align="left">
								<input id="developmentCharge" type="text" name="quality.developmentCharge" value="<s:property value="quality.developmentCharge"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
							<th>建设单位资质等级：</th>
							<td align="left">
								<input id="developmentQualificationLevel" type="text" name="quality.developmentQualificationLevel" value="<s:property value="quality.developmentQualificationLevel"/>" />
							</td>
                         </tr>
                         ...
                         <tr>
                         	<th>勘察单位：</th>
							<td colspan="3" align="left">
							<input id="surveyUnit" type="text" size="112" name="quality.surveyUnit" value="<s:property value="quality.surveyUnit"/>" />
                          ...
                          <tr>                          
                            <th>勘察单位资质等级：</th>
							<td align="left">
							<input id="surveyUnitQualificationLevel" type="text" name="quality.surveyUnitQualificationLevel" value="<s:property value="quality.surveyUnitQualificationLevel"/>" />
							</td>
                         	<th>勘察单位项目负责人：</th>
							<td align="left">
							<input id="surveyUnitCharge" type="text" name="quality.surveyUnitCharge" value="<s:property value="quality.surveyUnitCharge"/>" />
							</td>
                         </tr>
                           <tr>
	                            <th>勘察单位联系电话：</th>
                         ...
                         <tr>
                         	<th>设计单位：</th>
							<td colspan="3" align="left">
							<input id="designUnit" type="text" size="112" name="quality.designUnit" value="<s:property value="quality.designUnit"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
                         ...
                         <tr>                                                  
                            <th>设计单位资质等级：</th>
							<td align="left">
							<input id="designUnitQualificationLevel" type="text" name="quality.designUnitQualificationLevel" value="<s:property value="quality.designUnitQualificationLevel"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
                         	<th>设计单位项目负责人：</th>
							<td align="left">
							<input id="designUnitCharge" type="text" name="quality.designUnitCharge" value="<s:property value="quality.designUnitCharge"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
                         </tr>
                         ...
                         <tr>
                         	<th>监理单位：</th>
							<td colspan="3" align="left">
							<input id="supervisionUnit" type="text" size="112" name="quality.supervisionUnit" value="<s:property value="quality.supervisionUnit"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
                         ...
                         <tr>
                         	<th>监理单位资质等级：</th>
							<td align="left">
							<input id="supervisionUnitQualLevel" type="text" name="quality.supervisionUnitQualLevel" value="<s:property value="quality.supervisionUnitQualLevel"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
                         	<th>监理单位总监理工程师：</th>
							<td align="left">
							<input id="supervisionUnitEngineer" type="text" name="quality.supervisionUnitEngineer" value="<s:property value="quality.supervisionUnitEngineer"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
                         </tr>
                         ...
                         <tr>
                         	<th>施工单位：</th>
							<td colspan="3" align="left">
							<input id="constructionUnit" type="text" size="112" name="quality.constructionUnit" value="<s:property value="quality.constructionUnit"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
                         ...
                         <tr>
                         	<th>施工单位项目经理：</th>
							<td align="left">
							<input id="constructionUnitProjectManager" type="text" name="quality.constructionUnitProjectManager" value="<s:property value="quality.constructionUnitProjectManager"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>							
							<th>施工单位资质等级：</th>
							<td align="left">
							<input id="constructionUnitQualLevel" type="text" name="quality.constructionUnitQualLevel" value="<s:property value="quality.constructionUnitQualLevel"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
                         </tr>
                         ...
                         <tr>
                         	<th>施工图审查合格书：</th>
							<td colspan="3" align="left">
							<input id="constructionPlans" type="text" size="112" name="quality.constructionPlans" value="<s:property value="quality.constructionPlans"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
                         </tr>
                         <tr>
                         	<th>类别 ：</th>
						...
						<tr>
                         ...
                         <tr>
							...
							&nbsp;
							<input type="button" onclick="upload('<s:property value="quality.qualityId"/>')" value="上传" />
							</td>
						</tr>
						<tr>
                       		<th>附件：</th>
