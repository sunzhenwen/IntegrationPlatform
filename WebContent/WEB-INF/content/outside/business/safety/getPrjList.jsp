...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/queryPrjsAction_queryPage.action";
	...
	function corpChoose(value)
	{
		...
		var prjPropertyNum = strs[5];
		var projectManager=strs[6];
		var unitPhone=strs[7];
		var buildCorpName=strs[8];
		...
		parent.document.getElementById("projectManager").value=projectManager;
		parent.document.getElementById("unitPhone").value=unitPhone;
		parent.document.getElementById("buildCorpName").value=buildCorpName;	
		if(prjPropertyNum=="001"){
			parent.document.getElementById("eee").checked=true; 
		} else if(prjPropertyNum=="002"){
			parent.document.getElementById("eeee").checked=true; 
		}else if(prjPropertyNum=="003"){
			parent.document.getElementById("eeeeee").checked=true; 
		}else{
			
			parent.document.getElementById("eeeee").checked=true; 
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr>
                          	<td><input onclick="corpChoose(this.value)" type="radio" name="corpRadio" value="<s:property value="prjId"/>,<s:property value="prjNum"/>,<s:property value="prjName"/>,<s:property value="appDept"/>,<s:property value="appDeptName"/>,<s:property value="prjPropertyNum"/>,<s:property value="projectManager"/>,<s:property value="unitPhone"/>,<s:property value="buildCorpName"/>"></td>
