...
document.getElementById("jiandu").style.backgroundColor="#EBEBE4"; 
            ...
            <div class="ry_lbxx">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         ...
                         <tr>
                         	<th>申请企业名称：</th>
							<td align="left">
							<input type="text" id="qiye" readonly=false style="color:#707070" name="safety.applyCorpName" value="<s:property value="safety.applyCorpName"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
							<th>申请企业代码：</th>
							<td align="left">
							<input type="text" id="daima" readonly=false style="color:#707070" name="safety.applyCorpCode" value="<s:property value="safety.applyCorpCode"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							<input id="appDeptName" readonly=false type="hidden" name="safety.appDeptName" value="<s:property value="safety.appDeptName"/>" class="required"/>
                         ...
                         <tr>
							...
							<td colspan="3" align="left">
								...
								<input type="text" id="jiandu" size="108" readonly=false style="color:#707070" name="safety.safetyNum" value="<s:property value="safety.safetyNum"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
						</tr>
						 <tr>
                         ...
                         <tr>
                           <th>工程地点</th>
                            <td colspan="3" align="left">
                            <input id='projectAddress'  style="color:#707070" name="safety.projectAddress" type="text" value="<s:property value="safety.projectAddress"/>" size="108" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                         </tr>
                         <tr>
                           <th>合同开工日期</th>
                         ...
                         <tr>
                           <th>勘察单位全称</th>
                           <td colspan="3" align="left">
                            <input id='contractorCorpName' style="color:#707070"   type="text" name="safety.policingName" size="108" value="<s:property value="safety.policingName"/>" class="required"/><strong><font color="#FF0000">*</font></strong><a href="javascript:queryPrjNameKC()" onclick=""><span style="border-radius:6px; background:#497fe1; padding:4px 14px; color:#fff; font-size:12px;">选择</span></a></td>
                           </tr>
                            <tr>
                           <th>设计单位全称</th>                          
                           <td colspan="3" align="left">
                            <input id='contractorCorpNamesj' style="color:#707070"   type="text" size="108" name="safety.designName" value="<s:property value="safety.designName"/>" class="required"/><strong><font color="#FF0000">*</font></strong><a href="javascript:queryPrjNameSJ()" onclick=""><span style="border-radius:6px; background:#497fe1; padding:4px 14px; color:#fff; font-size:12px;">选择</span></a></td>
                            </tr>
                         <tr>
                           <th>设计单位项目负责人</th>
                           <td align="left"><input id='constructorNamesj' style="color:#707070"   type="text" name="safety.designStaff" value="<s:property value="safety.designStaff"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                        	...
                        	<th>勘察单位项目负责人</th>
                           <td align="left"><input id='constructorName' style="color:#707070"   type="text" name="safety.policingStaff" value="<s:property value="safety.policingStaff"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                         </tr>                       
                         <tr>
                           <th>建设单位全称</th>
                           <td align="left"><input   style="color:#707070" id='buildCorpName' type="text" name="safety.buildingName" value="<s:property value="safety.buildingName"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                           <th>建设单位项目负责人</th>
                           <td align="left"><input id='projectManager' style="color:#707070"   type="text" name="safety.buildingStaff" value="<s:property value="safety.buildingStaff"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                         </tr>
                         <tr>
                           <th>建设单位联系电话</th>
                           <td align="left"><input id='unitPhone' style="color:#707070"   type="text" name="safety.buildingPhone" value="<s:property value="safety.buildingPhone"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                           <td>&nbsp;</td>
                           <td>&nbsp;</td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                           <th>单位全称</th>
                             <td colspan="3" align="left">
                              <input id='contractorCorpNamejl' style="color:#707070"   type="text" name="safety.supervisionName" size="108" value="<s:property value="safety.supervisionName"/>" /><a href="javascript:queryPrjNameJL()" onclick=""><span style="border-radius:6px; background:#497fe1; padding:4px 14px; color:#fff; font-size:12px;">选择</span></a></td>
                         ...
                         <tr>
                           <th>单位全称</th>
                           <td colspan="3" align="left">
                            <input id='contractorCorpNamezb' style="color:#707070"   size="108" type="text" name="safety.contractName" value="<s:property value="safety.contractName"/>" /></td>                           
                         </tr> 
                         <tr>
                         <tr>
                           <th>安全管理负责人</th>
                            <td colspan="3" align="left">
                              <input id='FName' type="text" style="color:#707070"   name="safety.contractAdmin" size="108" value="<s:property value="safety.contractAdmin"/>" class="required"/><strong><font color="#FF0000">*</font></strong><a href="javascript:queryPrjNameAQFZ()" onclick=""><span style="border-radius:6px; background:#497fe1; padding:4px 14px; color:#fff; font-size:12px;">选择</span></a></td>
                           </tr>
                         <tr>
                         <th>安全考核证号</th>
                           <td align="left"><input id='FCertNumber' style="color:#707070"    type="text" name="safety.contractSafeNum" value="<s:property value="safety.contractSafeNum"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                         <th>联系电话</th>
                         ...
                         <th>项目负责人姓名</th>
                           <td colspan="3" align="left">
                              <input id='constructorNameXMFZ' style="color:#707070"   type="text" name="safety.contractProStaff" size="108" value="<s:property value="safety.contractProStaff"/>" class="required"/><strong><font color="#FF0000">*</font></strong><a href="javascript:queryPrjNameXMFZ()" onclick=""><span style="border-radius:6px; background:#497fe1; padding:4px 14px; color:#fff; font-size:12px;">选择</span></a></td>
                         </tr>
                         
                         <tr>
                           <th>项目负责人注册证号</th>
                           <td align="left"><input id='constructorNameZSBH' style="color:#707070"  type="text" name="safety.contractStaffRegNum" value="<s:property value="safety.contractStaffRegNum"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                           <th>项目负责人考核证号</th>
                           <td align="left"><input id='constructorNameKHBH' style="color:#707070"   type="text" name="safety.contractStaffNum" value="<s:property value="safety.contractStaffNum"/>" class="required"/><strong><font color="#FF0000">*</font></strong></td>
                         </tr>
                            <tr>               
                         ...
                         <tr>
                           ...
                           <a href="javascript:queryPrjNameLW()" onclick="" style="float:right;"><span style="border-radius:6px; background:#497fe1; padding:4px 14px; color:#fff; font-size:12px;">选择</span></a>	<a href="javascript:onAddTRss(this)" onclick="" style="float:right;"><span style="border-radius:6px; background:#497fe1; padding:4px 14px; color:#fff; font-size:12px;">添加</span></a>
                           </td>
                         </tr>
                ...
                <tr>
                	...
                	<s:iterator status="i" value="safety.accessoryList">
							<tr>
                       		<td style="background:#f5f5f5;" align="left" width="400"><s:property value="#i.count"/>、<s:property value="message"/></td>
