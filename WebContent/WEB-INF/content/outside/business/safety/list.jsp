...
<script type="text/javascript">
	...
	function addTitle()
	{
		document.form1.action="<%=basepath %>/safetyAction_addPage.action";
		document.form1.submit();
	}
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/safetyAction_goBack.action";
		document.form1.submit();
	}
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">企业安全监督申请列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                            <s:if test="appType==0">
                            	<a href="safetyAction_modifyPage.action?safetyId=<s:property value="safetyId"/>"><span>修改</span></a>	
                            	&nbsp;
                            	<a href="safetyAction_delete.action?safetyId=<s:property value="safetyId"/>"><span>删除</span></a>
                            </s:if>
                            <s:if test="appType==2">
                            	<a href="safetyAction_delete.action?safetyId=<s:property value="safetyId"/>"><span>删除</span></a>
                            </s:if>
