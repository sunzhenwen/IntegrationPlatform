                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr>
                          	<td><input onclick="corpChoose(this.value)" type="radio" name="corpRadio" value="<s:property value="prjId"/>,<s:property value="prjNum"/>,<s:property value="prjName"/>,<s:property value="appDept"/>,<s:property value="appDeptName"/>,<s:property value="prjPropertyNum"/>"></td>
