...
<script type="text/javascript">
	...
	function addTitle()
	{
		document.form1.action="<%=basepath %>/constructionPlansAction_addPage.action";
		document.form1.submit();
	}
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/constructionPlansAction_goBack.action";
		document.form1.submit();
	}
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">施工图审查申请列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                            <s:if test="appType==0">
                            	<a href="constructionPlansAction_modifyPage.action?censorId=<s:property value="censorId"/>"><span>修改</span></a>	
                            	&nbsp;
                            	<a href="constructionPlansAction_delete.action?censorId=<s:property value="censorId"/>"><span>删除</span></a>
                            </s:if>
                            <s:if test="appType==2">
                            	<a href="constructionPlansAction_delete.action?censorId=<s:property value="censorId"/>"><span>删除</span></a>
                            </s:if>
