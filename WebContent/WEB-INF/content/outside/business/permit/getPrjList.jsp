...
<script type="text/javascript">
	...
	function corpChoose(value)
	{
		...
		var buldPlanNum = strs[5]
		var projectPlanNum = strs[6];
		...
		parent.document.getElementById("buldPlanNum").value=buldPlanNum;
		parent.document.getElementById("projectPlanNum").value=projectPlanNum;
		window.close();
	}
</script>
</head>
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr>
                          	<td><input onclick="corpChoose(this.value)" type="radio" name="corpRadio" value="<s:property value="prjId"/>,<s:property value="prjNum"/>,<s:property value="prjName"/>,<s:property value="appDept"/>,<s:property value="appDeptName"/>,<s:property value="buldPlanNum"/>,<s:property value="projectPlanNum"/>"></td>
