	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">施工图审查查询列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                         ...
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                             ...
                             -->
                            <td>
                            	<a href="queryConstructionPlansAction_modifyPage.action?censorId=<s:property value="censorId"/>"><span>详细</span></a>	
                            </td>
                         </tr>
						 </s:iterator>
