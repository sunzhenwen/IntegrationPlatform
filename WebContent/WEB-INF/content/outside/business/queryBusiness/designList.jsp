...
<script type="text/javascript">
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/queryDesignAction_goBack.action";
		document.form1.submit();
	}
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">企业项目设计查询列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                            	<a href="queryDesignAction_modifyPage.action?designId=<s:property value="designId"/>"><span>详细</span></a>	
                            </td>
                         </tr>
						 </s:iterator>
