...
<script type="text/javascript">
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/querySafetyAction_goBack.action";
		document.form1.submit();
	}
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">企业安全监督查询列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                            	<a href="querySafetyAction_modifyPage.action?safetyId=<s:property value="safetyId"/>"><span>详细</span></a>	
                         </tr>
						 </s:iterator>
