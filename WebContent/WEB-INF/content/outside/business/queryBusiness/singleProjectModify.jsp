...
function save(){
	...
	$().ready(function() {
	 	$("#form1").validate({
	 		submitHandler:function(form){
	 			$("#form1").attr("action", "<%=basepath %>/querySingleProjectAction_modify.action");
	...
	{
		window.name="win_test"
		document.form1.action="<%=basepath %>/querySingleProjectAction_goList.action";
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         <tr>
                        	...
                        	<input id="prjId" type="hidden" name="prjId" value="<s:property value="singleProject.prjId"/>" />
