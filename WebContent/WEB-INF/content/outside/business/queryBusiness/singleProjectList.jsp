...
<script type="text/javascript">
	...
	function queryTitle()
	{
		document.form1.action="<%=basepath %>/querySingleProjectAction_queryPage.action";
	...
	function addTitle()
	{
		document.form1.action="<%=basepath %>/querySingleProjectAction_addPage.action";
		document.form1.submit();
	}
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                            	<a href="querySingleProjectAction_modifyPage.action?spId=<s:property value="spId"/>"><span>查看</span></a>
                            </td>
                         </tr>
						 </s:iterator>
