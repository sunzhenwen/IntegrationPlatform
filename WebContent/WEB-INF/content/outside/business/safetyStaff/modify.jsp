...
<input type="hidden" id="message" value="<s:property value="message" />" />
	...
	<form id="form1" name="form1" method="post" action="<%=basepath %>/safetyStaffAction_modify.action">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         <tr>
							...
							<input type="hidden" name="safetyStaff.builderUserId" value="<s:property value="safetyStaff.builderUserId"/>"/>
                         ...
                         <tr>
                         	<th>所属单位名称：</th>
							<td align="left">
							<input type="text" readonly name="safetyStaff.corpName" value="<s:property value="safetyStaff.corpName"/>" class="required"/>
							</td>
							<th>所属单位组织机构改代码：</th>
							<td align="left">
							<input type="text" readonly name="safetyStaff.corpCode" value="<s:property value="safetyStaff.corpCode"/>" class="required"/><strong><font color="#FF0000">*</font></strong>
							</td>
                         </tr>
                         <tr>
                         	<th>施工许可证编号：</th>
