...
<script type="text/javascript">
	...
	function addTitle()
	{
		document.form1.action="<%=basepath %>/safetyStaffAction_addPage.action";
		document.form1.submit();
	}
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/safetyStaffAction_goBack.action";
		document.form1.submit();
	}
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">施工安全从业人员列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                            	<a href="safetyStaffAction_modifyPage.action?builderUserId=<s:property value="builderUserId"/>"><span>修改</span></a>	
                            	&nbsp;
                            	<a href="safetyStaffAction_delete.action?builderUserId=<s:property value="builderUserId"/>"><span>删除</span></a>
                         </tr>
						 </s:iterator>
