...
<input type="hidden" id="message" value="<s:property value="message" />" />
	...
	<form id="form1" name="form1" method="post" action="<%=basepath %>/designSurveyStaffAction_modify.action">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         <tr>
							...
							<input type="hidden" name="dsStaff.dsId" value="<s:property value="dsStaff.dsId"/>"/>
                         ...
                         <tr>
							...
							<input type="hidden" name="dsStaff.conCorpName" value="<s:property value="dsStaff.conCorpName"/>"/>
							</td>
							<th>所属单位组织机构改代码：</th>
							<td align="left">
							...
							<input type="hidden" name="dsStaff.conCorpCode" value="<s:property value="dsStaff.conCorpCode"/>" />
							</td>
                         </tr>
