...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/QualitySJAction_queryPageSJ.action";
	...
	function corpChoose(value)
	{
		...
		parent.document.getElementById("contractorCorpNamesj").value=contractorCorpName;
		parent.document.getElementById("constructorNamesj").value=constructorName;
		window.close();
	}
</script>
</head>
	...
	<div class="ry_wrapp">
        ...
        <div class="ry_content">
            ...
            <div class="ry_liebiao">
            	<p class="f16 fb">设计企业选择<img src="<%=basepath %>/images/ry_lie.png" /></p>
