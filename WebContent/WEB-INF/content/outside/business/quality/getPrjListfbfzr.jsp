...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/QualityfbfzrAction_queryPageanfzc.action";
		document.form1.submit();
	}
	
	function corpChoose(value)
	{   
		var k=<%=session.getAttribute("userrrr")%>;
		//alert(k);
		...
		parent.document.getElementById("FNamee["+k+"]").value=FName;
		parent.document.getElementById("FCertNumberr["+k+"]").value=FCertNumber;
		window.close();
	}
</script>
</head>
	...
	<div class="ry_wrapp">
        ...
        <div class="ry_content">
        	...
        	<div class="ry_main" cellpadding="0" cellspacing="0">
            	...
            	<table class="ry_left left">              
                    <tr>
                        ...
                        <input type="hidden" name="contractorCorpNamefb" value = "<s:property value = "contractorCorpNamefb"/>" />
                        </td>                     
                    </tr>
                </table>	
            ...
            <div class="ry_liebiao">
            	<p class="f16 fb">项目负责人<img src="<%=basepath %>/images/ry_lie.png" /></p>
