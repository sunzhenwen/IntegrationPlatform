...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/contractCorpQualAction_queryPageD.action";
	...
	<div class="ry_wrapp">
        ...
        <div class="ry_content">
            ...
            <div class="ry_liebiao">
            	<p class="f16 fb">勘察企业招投标信息选择<img src="<%=basepath %>/images/ry_lie.png" /></p>
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr>
                          	<td><input onclick="corpChoose(this.value)" type="radio"
                          	 name="corpRadio" 
                          	 value="<s:property value="CONTRACTORCORPNAME"/>,<s:property value="TITLELEVE"/>,<s:property value="CONSTRUCTORNAME"/>,<s:property value="PHONE"/>">
                          	 </td>
