...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/contractCorpQualAction_queryPageA.action";
	...
	function corpChoose(value)
	{
		...
		parent.document.getElementById("surveyUnit").value=CONTRACTORCORPNAME;
		parent.document.getElementById("surveyUnitQualificationLevel").value=TITLELEVE;
		parent.document.getElementById("surveyUnitCharge").value=CONSTRUCTORNAME;
		parent.document.getElementById("surveyUnitPhone").value=PHONE;
		parent.document.getElementById("econCorpCode").value=CONTRACTORCORPCODE;
        ...
        <div class="ry_content">
        	...
        	<div class="ry_main" cellpadding="0" cellspacing="0">
            	...
            	<table class="ry_left left">
                	...
                	<tr>
                	 <td>项目名称：</td>
                	 <td align="left"><input type="text" name="condition.prjName" /></td>                	
                	</tr>
                	<!--  
                	<tr>           
                        <td>时间：</td>
            ...
            <div class="ry_liebiao">
            	<p class="f16 fb">勘察企业信息选择<img src="<%=basepath %>/images/ry_lie.png" /></p>
