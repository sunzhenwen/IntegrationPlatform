...
<script type="text/javascript">
	...
	{
		document.form1.action="<%=basepath %>/contractCorpQualAction_queryPageC.action";
	...
	function corpChoose(value)
	{
		...
		var PHONE = strs[3];
		//var RECORDNUM = strs[4];
		var CONTRACTORCORPCODE = strs[4];
		

		parent.document.getElementById("supervisionUnit").value=CONTRACTORCORPNAME;
		parent.document.getElementById("supervisionUnitQualLevel").value=TITLELEVE;
		parent.document.getElementById("supervisionUnitEngineer").value=CONSTRUCTORNAME;
		parent.document.getElementById("supervisionUnitPhone").value=PHONE;
		//parent.document.getElementById("supervisionContractFileNum").value=RECORDNUM;
	...
	<div class="ry_wrapp">
        ...
        <div class="ry_content">
            ...
            <div class="ry_liebiao">
            	<p class="f16 fb">监理企业信息选择<img src="<%=basepath %>/images/ry_lie.png" /></p>
