...
<script type="text/javascript">
	 		...
	 		submitHandler:function(form){
	            var check = /^([1-9]\d*|0)(\.\d*[1-9])?$/; 
	 			...
	 			}else
	 			{
		 			...
		 			{
	 					$("#form1").attr("action", "<%=basepath %>/supervisorContractFilingAction_modify.action");
	...
	function upload(count,id,accessotyId,linkName)
	{
		...
		if(uf!="")
		{
			...
			var actionUrl = "<%=basepath %>/fileUpload_uploadFile.action?id="+id+"&accessotyId="+accessotyId+"&linkName="+linkName+"&returnRoot=supervisContractFiling";
	...
	{
		document.form1.action="<%=basepath %>/fileUpload_deleteFile.action?id="+uploadId+"&returnRoot=supervisContractFiling";
		document.form1.submit();
	}
	//下载
	function downLoad(uploadId)
	{
		document.form1.action="<%=basepath %>/fileUpload_downLoadFile.action?id="+uploadId+"&returnRoot=supervisContractFiling";
		document.form1.submit();
	}
</script>
