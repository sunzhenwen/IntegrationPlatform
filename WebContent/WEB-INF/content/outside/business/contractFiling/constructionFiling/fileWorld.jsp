...
<script type="text/javascript">
	...
	function sub()
	{
		document.form1.action="<%=basepath %>/theContractorAction_sub.action";
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/fileWorldAction_goTheContractor.action";
		document.form1.submit();
	}	
</script>
</head>
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">市建合同<img src="<%=basepath %>/images/ry_lie.png" /></p>
