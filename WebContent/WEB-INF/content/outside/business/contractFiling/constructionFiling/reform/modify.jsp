...
<title>建设工程施工合同（发改法规[2011]3018号）合同备案 </title>
<script type="text/javascript">
	 		...
	 		submitHandler:function(form){
	            var check = /^([1-9]\d*|0)(\.\d*[1-9])?$/; 
	 			...
	 			}else
	 			{
		 			...
		 			{
	 					$("#form1").attr("action", "<%=basepath %>/reformAction_modify.action");
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/reformAction_goList.action";
	...
	function upload(count,id,accessotyId,linkName)
	{
		...
		if(uf!="")
		{
			...
			var actionUrl = "<%=basepath %>/fileUpload_uploadFile.action?id="+id+"&accessotyId="+accessotyId+"&linkName="+linkName+"&returnRoot=reformContractFiling";
	...
	{
		document.form1.action="<%=basepath %>/fileUpload_deleteFile.action?id="+uploadId+"&returnRoot=reformContractFiling";
		document.form1.submit();
	}
	//下载
	function downLoad(uploadId)
	{
		document.form1.action="<%=basepath %>/fileUpload_downLoadFile.action?id="+uploadId+"&returnRoot=reformContractFiling";
		document.form1.submit();
	}
</script>
        ...
        <div class="ry_content">
            ...
            <div class="ry_lbxx">
            	<div class="ry_lbcontent" cellpadding="0" cellspacing="0">
              	<h2>建设工程施工合同（发改法规[2011]3018号）</h2>
