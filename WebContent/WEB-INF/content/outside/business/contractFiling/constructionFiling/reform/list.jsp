...
<script type="text/javascript">
	...
	function addTitle()
	{
		document.form1.action="<%=basepath %>/reformAction_addPage.action";
		document.form1.submit();
	}
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">建设工程施工合同（发改法规[2011]3018号）<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <s:if test="appType==3">
                            	<a href="reformAction_modifyPage.action?recordId=<s:property value="recordId"/>"><span>基本信息修改</span></a>	
                            	&nbsp;
                            	<a href="fileWorldAction_fileWorldPage.action?recordId=<s:property value="recordId"/>&conType=1"><span>合同信息编辑</span></a>	
                            	&nbsp;
                            	<a href="reformAction_delete.action?recordId=<s:property value="recordId"/>"><span>删除</span></a>
                            </s:if>
                            <!-- 
                            <s:if test="appType==0">
                            	<a href="reformAction_modifyPage.action?recordId=<s:property value="recordId"/>"><span>基本信息修改</span></a>	
