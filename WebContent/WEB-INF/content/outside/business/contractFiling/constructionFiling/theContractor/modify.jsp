...
<title>建设工程施工合同（建市[2010]88号）合同备案 </title>
<script type="text/javascript">
	 		...
	 		submitHandler:function(form){
	            var check = /^([1-9]\d*|0)(\.\d*[1-9])?$/; 
	 			...
	 			}else
	 			{
		 			...
		 			{
	 					$("#form1").attr("action", "<%=basepath %>/theContractorAction_modify.action");
	...
	function goBack()
	{
		document.form1.action="<%=basepath %>/theContractorAction_goList.action";
	...
	function queryTenderInfo()
	{
		...
		var url="<%=basepath %>/theContractorTenderInfoAction_queryPage.action?condition.prjNum="+prjNum;
	...
	function queryTitleLeve()
	{
		...
		var url2="<%=basepath %>/theContractorTitleLeveAction_queryPage.action?condition.tenderCorpCode="+tenderCorpCode;
	...
	function upload(count,id,accessotyId,linkName)
	{
		...
		if(uf!="")
		{
			...
			var actionUrl = "<%=basepath %>/fileUpload_uploadFile.action?id="+id+"&accessotyId="+accessotyId+"&linkName="+linkName+"&returnRoot=theContractorSuccess";
	...
	{
		document.form1.action="<%=basepath %>/fileUpload_deleteFile.action?id="+uploadId+"&returnRoot=theContractorSuccess";
		document.form1.submit();
	}
	//下载
	function downLoad(uploadId)
	{
		document.form1.action="<%=basepath %>/fileUpload_downLoadFile.action?id="+uploadId+"&returnRoot=theContractorSuccess";
		document.form1.submit();
	}
</script>
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
						...
						<tr>
                         	<th>合同开工日期：</th>
							<td align="left">
							<input id="time2" type="text" name="contractFiling.contractStart" value="<s:date name="contractFiling.contractStart" format="yyyy-MM-dd" />" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,isShowClear:true,readOnly:true})" class="required" /><strong><font color="#FF0000">*</font></strong>
							</td>
							<th>合同竣工日期：</th>
							<td align="left">
							<input id="time3" type="text" name="contractFiling.contractEnd" value="<s:date name="contractFiling.contractEnd" format="yyyy-MM-dd" />" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true,isShowClear:true,readOnly:true})" class="required" /><strong><font color="#FF0000">*</font></strong>
							</td>
						</tr>
						<tr>
