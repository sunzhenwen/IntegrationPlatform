...
<input type="hidden" id="message" value="<s:property value="message" />" />
	...
	<form id="form1" name="form1" method="post" action="<%=basepath %>/theContractorAction_add.action">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
                         <tr>
							...
							<input type="hidden" name="contractFiling.contractTypeNum" value="<s:property value="301"/>" class="required"/>
							<input type="hidden" name="contractFiling.contrType" value="1" class="required"/>
