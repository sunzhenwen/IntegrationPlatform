...
<base target="_self" />
<title>设计招投标信息选择</title>
<script type="text/javascript">
	//查询
	function queryCorpInfo()
	{
		document.form1.action="<%=basepath %>/designTenderInfoAction_queryPage.action";
	...
	<div class="ry_wrapp">
        ...
        <div class="ry_content">
            ...
            <div class="ry_liebiao">
            	<p class="f16 fb">设计招投标信息选择<img src="<%=basepath %>/images/ry_lie.png" /></p>
