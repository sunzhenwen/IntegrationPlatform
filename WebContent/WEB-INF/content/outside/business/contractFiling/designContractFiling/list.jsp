...
<script type="text/javascript">
	...
	function addTitle()
	{
		document.form1.action="<%=basepath %>/designContractFilingAction_addPage.action";
		document.form1.submit();
	}
	...
	<div class="ry_wrapp">
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="ry_liebiao">
            	<p class="f16 pd10 fb">企业设计合同备案<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         <tr>
                          ...
                          <tr>
                            ...
                            <td>
                            <s:if test="appType==0">
                            	<a href="designContractFilingAction_modifyPage.action?recordId=<s:property value="recordId"/>"><span>修改</span></a>	
                            	&nbsp;
                            	<a href="designContractFilingAction_delete.action?recordId=<s:property value="recordId"/>"><span>删除</span></a>
                            </s:if>
                            <s:if test="appType==2">
                            	<a href="designContractFilingAction_delete.action?recordId=<s:property value="recordId"/>"><span>删除</span></a>
                            </s:if>
