...
<script type="text/javascript">
	...
	function upload(count,id,accessotyId,linkName)
	{
		...
		if(uf!="")
		{
			...
			var actionUrl = "<%=basepath %>/fileUpload_uploadFile.action?id="+id+"&accessotyId="+accessotyId+"&linkName="+linkName+"&returnRoot=completeSuccess";
	...
	{ 
		var prjNum = $("#prjNum").val();
		var prjId = $("#prjId").val();
		var url = "<%=basepath %>/singleProjectAction_queryPage.action?prjNum="+prjNum+"&prjId="+prjId+"&condition.prjId="+prjId+"&condition.linkName=6&linkName=6";
            ...
            <div class="ry_lbxx">
                ...
                <table class="" cellpadding="0" cellspacing="0">
                	<tbody>   
						...
						<s:iterator status="i" value="complete.accessoryList">
							<tr>
							...
							&nbsp;
							<input type="button" onclick="upload('<s:property value="#i.count"/>','<s:property value="complete.completeId"/>','<s:property value="id"/>','<s:property value="linkName"/>')" value="上传" />
							&nbsp;<br />
