...
<title>质量勘察统计分析 </title>
<script type="text/javascript" src="<%=basepath %>/js/highcharts/js/highcharts.js"></script>
<script type="text/javascript">
	//查询
	function queryTitle()
	{
		document.form1.action="<%=basepath %>/qualityCountAction_queryPage.action";
	...
	function queryArea(){
       $(document).ready(function(){
           ...
           $.ajax({
               url: 'qualityCountAction_queryArea.action',
               type: 'post',
               dataType: 'json',
               data: 'cityId='+cityId,
	...
	$(function () {
		...
		$('#container').highcharts({
	        ...
	        title: {
	            text: '<s:property value="title"/>质量勘察区域分布统计'
	        },
	        subtitle: {
