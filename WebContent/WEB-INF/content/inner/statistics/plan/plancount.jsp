...
<title>施工图审统计分析 </title>
<script type="text/javascript" src="<%=basepath %>/js/highcharts/js/highcharts.js"></script>
<script type="text/javascript">
	//查询
	function queryTitle()
	{
		document.form1.action="<%=basepath %>/planCountAction_queryPage.action";
	...
	$(function () {
	    ...
	    $('#container').highcharts({
	        ...
	        title: {
	            text: '<s:property value="title"/>施工图审区域分布统计'
	        },
	        subtitle: {
	    ...
	    $('#containerPie').highcharts({
	        ...
	        title: {
	            text: '<s:property value="title"/>施工图区域分布统计'
	        },
	        tooltip: {
	...
	function queryArea(){
       $(document).ready(function(){
           ...
           $.ajax({
               url: 'planCountAction_queryArea.action',
               type: 'post',
               dataType: 'json',
               data: 'cityId='+cityId,
