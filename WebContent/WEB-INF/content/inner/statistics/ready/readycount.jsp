...
<title>竣工验收统计分析 </title>
<script type="text/javascript" src="<%=basepath %>/js/highcharts/js/highcharts.js"></script>
<script type="text/javascript">
	//查询
	function queryTitle()
	{
		document.form1.action="<%=basepath %>/readyCountAction_queryPage.action";
	...
	$(function () {
		...
		$('#container').highcharts({
	        ...
	        title: {
	            text: '<s:property value="title"/>竣工验收区域分布统计'
	        },
	        subtitle: {
	...
	function queryArea(){
       $(document).ready(function(){
           ...
           $.ajax({
               url: 'readyCountAction_queryArea.action',
               type: 'post',
               dataType: 'json',
               data: 'cityId='+cityId,
