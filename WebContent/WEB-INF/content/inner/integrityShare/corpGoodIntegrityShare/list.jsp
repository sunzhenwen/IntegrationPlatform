...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath%>/corpGoodIntegrityShareAction_queryPage.action";
		document.form1.submit();
	}
	function queryInfo()
	{
		document.form1.action="<%=basepath%>/corpGoodIntegrityShareAction_queryInfoPage.action";
		document.form1.submit();
	}
					...
					<table class="" cellpadding="0" cellspacing="0">
						<tbody>
							...
							已发布
									...
									<td align='center' width="65px"><s:if test="condition.personalID == 1">
											<%-- <a
												...
												<a
												href="corpGoodIntegrityShareAction_detailPage.action?corpGoodCreditId=<s:property value="corpGoodCreditId"/>"><span
