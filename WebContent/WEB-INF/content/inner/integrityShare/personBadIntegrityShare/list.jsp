...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath %>/personBadIntegrityShareAction_queryPage.action";
		document.form1.submit();
	}
	function queryInfo()
	{
		document.form1.action="<%=basepath%>/personBadIntegrityShareAction_queryInfoPage.action";
		document.form1.submit();
	}
	...
	function add()
	{
		document.form1.action="<%=basepath %>/personBadIntegrityAction_addPage.action";
		document.form1.submit();
	}
        ...
        <form>
        	<div class="ry_main" cellpadding="0" cellspacing="0">
                ...
                <table class="ry_right left">
                	<tr>
                        <td><s:if test="condition.personalID == 1"><input type="image" onclick="query()" src="<%=basepath %>/images/ry_look.png" /></s:if>
                        <s:if test="condition.personalID != 1"><input type="image" onclick="queryInfo()"
									src="<%=basepath%>/images/ry_look.png" />
									</s:if>
									</td>
                        <td>
                        	<%-- <s:if test="condition.personalID == 1"><input type="image" onclick="add()" src="<%=basepath %>/images/tianjia.png" /></s:if> --%>
            ...
            <div class="ry_liebiao">
            	<p class="f16 fb">人员不良行为信息列表<img src="<%=basepath %>/images/ry_lie.png" /></p>
                	...
                	<tbody>   
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr style="font-size: x-small;">
                            ...
                            <td align='center'>
                            <s:if test="condition.personalID == 1">
                            <%-- <a href="personBadIntegrityAction_modifyPage.action?badPersonId=<s:property value="badPersonId"/>"><span class="lbmingx">修改</span></a>
                            &nbsp;
                            <a href="personBadIntegrityAction_delete.action?badPersonId=<s:property value="badPersonId"/>"><span class="lbmingx">删除</span></a> --%>
                            	<a href="personBadIntegrityShareAction_detail.action?badPersonId=<s:property value="badPersonId"/>"><span class="lbmingx">详细</span></a>
                            </s:if>
                            <s:if test="condition.personalID != 1">
                            <a href="personBadIntegrityShareAction_detail.action?badPersonId=<s:property value="badPersonId"/>"><span class="lbmingx">详细</span></a>
                            </s:if>
