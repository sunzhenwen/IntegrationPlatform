...
<script type="text/javascript">
	...
	function goBack()
	{
		document.form1.action="<%=basepath%>/corpBadIntegrityShareAction_goBack.action";
			...
			<form style="margin: 50px;" id="form1" name="form1" method="post"
				...
				<table class="sp_mtable" style="border-collapse: collapse;"
					...
					<tr>
						<td>不良行为类别：</td>
						<td>
							<%-- <select name="corpBadIntegrity.creditType">
								<option value="">请选择</option>
							...
							<s:property value="corpBadIntegrity.creditType"/>
						</td>
						<td>不良行为代码：</td>
						<td>
							<%-- <select name="corpBadIntegrity.creditCode">
									<option value="">请选择</option>
							...
							<s:property value="corpBadIntegrity.creditCode"/>
						</td>
					</tr>
					<tr>
						<td>不良行为内容：</td>
					...
					<tr>
						...
						<td>处罚依据：</td>
						<td>
							<%-- <select name="corpBadIntegrity.punishEvidence">
									<s:iterator value="puishEvidences">
										<option value="<s:property value="code"/>"><s:property
												value="name" /></option>
									</s:iterator>
							</select> --%>
							<s:property value="corpBadIntegrity.punishEvidence"/>
						...
						<td>
							...
							<s:property value="corpBadIntegrity.punishContent"/>
						</td>
