...
<body>
	...
	<div class="qy_wrapp">
		...
		<div class="sp_main">
			...
			<h2 class="f16 fb" style="background: #3874d3;">修改行业标准</h2>
			<form style="margin: 50px;" id="form1" name="form1" method="post"
				action="<%=basepath%>/industryStandardAction_modify.action"
				...
				<table class="sp_mtable" style="border-collapse: collapse;"
					...
					<tr>
						...
						<input type="text" size="50" maxlength='200' name="industryStandard.title"
							value="<s:property value="industryStandard.title"/>" class="required" />
						<input type="hidden" name="industryStandard.isId"
							value="<s:property value="industryStandard.isId"/>"  />
							<input type="hidden" id="mes"  name="mes"  value = "<s:property value="industryStandard.message"/>" />
						</td>
