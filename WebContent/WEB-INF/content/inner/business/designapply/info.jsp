...
<script type="text/javascript">
	...
	function goBack()
	{
		document.form1.action="<%=basepath%>/designHistoryAction_goBack.action";
...
<body>
	<div class="qy_wrapp">
		...
		<div class="sp_main">
			...
			<h2 class="f16 fb" style="background: #80aced;">设计项目审核</h2>
				...
				<table class="sp_mtable" style="border-collapse: collapse;"
					...
					<tr>
						...
						<td><s:property value="project.prjNum" /> <input
							type="hidden" name="project.designId"
							value="<s:property value="project.designId"/>"> <input
					...
					<tr>
						<td>设计编码：</td>
						<td><s:property value="project.designNum" /></td>
						<td>设计单位名称：</td>
						<td><s:property value="project.designCorpName" /></td>
					</tr>
					<tr>
						<td>设计单位组织机构代码证：</td>
						<td><s:property value="project.designCorpCode" /></td>
						<td>申请企业组织机构代码证：</td>
					...
					<tr style="height: 60px; border: 0">
						<td>审核结果：</td>
						<td>
							<s:if test="project.appType==0">待审核</s:if>
							<s:if test="project.appType==1">审核通过</s:if>
							<s:if test="project.appType==2">审核不通过</s:if>
						</td>
						<td>审核意见：</td>
...
<table border="1" width="100%" height="100%" style="border:solid 1px black;border-collapse:collapse">
  <tr>
   ...
   <tr>
    <td width="20%" ><p align="center">设计编码</p></td>
    <td width="80%" colspan="4" ><p align="center"><s:property value="project.designNum" /></p></td>
  </tr>
   ...
   <tr>
    ...
    <td width="80%" colspan="4" ><p align="center"><s:property value="project.designCorpName" /> </p></td>
  </tr>
  ...
  <tr>
    <td colspan="2" width="50%"><p>设计单位意见：</p>
        <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; （公章） </p>       
        <p>&nbsp; </p>
        <p>&nbsp; </p>
        <p>&nbsp; </p>
