...
function downLoad(uploadId)
{
	...
	function applythrough()
	{
		...
		if(nm.value != "")
		{
			document.form1.action="<%=basepath%>/designApplyAction_applySuccess.action";
			document.form1.submit();
		}else
		{
			alert("请输入审核意见!");	
	...
	function applyBack()
	{
		...
		if(nmv.value != "")
		{
			document.form1.action="<%=basepath%>/designApplyAction_applyFaile.action";
			document.form1.submit();
		}else
		{
			alert("请输入审核意见!");	
	...
	function goBack()
	{
		document.form1.action="<%=basepath%>/designApplyAction_goBack.action";
		document.form1.submit();
	}
...
<table border="1" width="100%" height="100%" style="border:solid 1px black;border-collapse:collapse">
  <tr>
   ...
   <tr>
    ...
    <td width="80%" colspan="4" ><p>&nbsp;<s:property value="project.designCorpName" /> </p></td>
  </tr>
