...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath%>/surveyHistoryAction_queryHistoryPage.action";
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<td align='center'><a
							href="surveyHistoryAction_queryHistory.action?surveyId=<s:property value="surveyId"/>">详细</a>
						</td>
					</tr>
				</s:iterator>
