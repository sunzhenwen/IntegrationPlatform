...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath%>/filingApplyAction_queryPage.action";
		...
		<form id="form1" name="form1" method="post" action="">
			<table width="100%" border="0" cellpadding="0" height="15%">
				<tr>
					<td>
						<fieldset>
							<legend class="chaxuntj">勘察合同备案</legend>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<td align='center'><a
							href="filingApplyAction_queryapproval.action?recordId=<s:property value="recordId"/>">备案</a>
						</td>
					</tr>
				</s:iterator>
