...
<script type="text/javascript">
	...
	function goBack()
	{
		document.form1.action="<%=basepath%>/readyHistoryAction_goBack.action";
		...
		<div class="sp_main">
			...
			<form style="margin: 50px;" id="form1" name="form1" method="post"
				...
				<table class="sp_mtable" style="border-collapse: collapse;"
					...
					<tr>
						<td>审核单位：</td>
						<td><s:property value="complete.appSteffName" /></td>
						<td>审核时间：</td>
						<td><s:date name="complete.appDate" format="yyyy-MM-dd" /></td>
					</tr>
					<tr style="height: 60px; border: 0">
						<td>审核结果：</td>
						<td><s:if test="complete.appType==0">待审核</s:if> <s:if
								test="complete.appType==1">审核通过</s:if> <s:if
								test="complete.appType==2">审核不通过</s:if></td>
						<td>审核意见：</td>
						<td colspan="3"><textarea id="appId"
								name="complete.appOpinion" class="required"><s:property
									value="complete.appOpinion" /></textarea></td>
					</tr>
				</table>
				<div class="sp_bton">
...
<table border="1" width="100%" height="90%" style="border:solid 1px black;border-collapse:collapse">
  ...
  <tr>
    ...
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="complete.prjName" /></p></td>
  </tr>
   <tr>
    <td width="20%" ><p align="center"> 项目编号</p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="complete.prjNum" /></p></td>
  </tr>
  <tr>
    <td width="20%" ><p align="center">竣工备案编号 </p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="complete.prjFinishNum" /></p></td>
  </tr>
  <tr>
    <td width="20%" ><p align="center">施工许可证编号 </p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="complete.builderLicenceNum" /></p></td>
  </tr>
  <tr>
    <td width="20%" ><p align="center">质量检测机构名称 </p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="complete.qcCorpName" /></p></td>
  </tr>
  			
   <tr>
    <td width="20%"><p align="center">实际造价 </p></td>
    <td width="30%"><p align="center">&nbsp; <s:property value="complete.factCost" /></p></td>
    <td width="20%"><p align="center">实际面积 </p></td>
    <td width="30%"><p align="center">&nbsp; <s:property value="complete.factArea" /></p></td>
  </tr> 	
 ...
 <tr>
    ...
    <td width="80%" colspan="3" >
    	<p>&nbsp; </p>
        <p align="center">&nbsp; <s:property value="complete.factSize" /></p>
        <p>&nbsp; </p>
        </td>
 </tr> 	
 ...
 <tr>
    ...
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:if test="complete.prjStructureTypeNum==1">砖混结构</s:if>
							<s:if test="complete.prjStructureTypeNum==2">底框结构</s:if> <s:if
								test="complete.prjStructureTypeNum==3">框架结构</s:if> <s:if
								test="complete.prjStructureTypeNum==4">框架－剪力墙结构</s:if> <s:if
								test="complete.prjStructureTypeNum==5">剪力墙结构</s:if> <s:if
  ...
  <tr>
    ...
    <td width="30%"><p align="center">&nbsp; <s:date name="complete.BDate" format="yyyy-MM-dd" /></p></td>
    <td width="20%"><p align="center">实际竣工验收日期 </p></td>
    <td width="30%"><p align="center">&nbsp; <s:date name="complete.EDate" format="yyyy-MM-dd" /></p></td>
  </tr> 
  
  <tr>
    <td width="20%" ><p align="center">记录登记日期 </p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:date name="complete.createDate" format="yyyy-MM-dd" /></p></td>
  </tr>
