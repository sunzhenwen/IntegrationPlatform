...
function downLoad(uploadId)
{
	...
	function query()
	{
		document.form1.action="<%=basepath%>/promiseApplyAction_querypagey.action";
		document.form1.submit();
	}
	//查询
	function goBack()
...
<body>
	<div class="libiao">
		<form id="form1" name="form1" method="post" action="<%=basepath %>/querscenesafeAction_querypagey.action">
						...
						<fieldset>
							...
							<table width="100%" border="0" align="left" cellpadding="0"
								...
								<tr>
									<td>项目编号:</td>
									<td> 
										<s:property value="scenesafe.prjnumm" /> </td>
									<td>施工许可证号:</td>
									<td> 
									 <s:property value="scenesafe.prjnumm"/> 
							        </td>
								</tr>
								<tr>
									<td >项目名称:</td>
									<td colspan="3" align="left" >  
									<s:property value="scenesafe.prjnamee"/>
									</td>														
								</tr>
								<tr>
									<td>检查人:</td>
                         ...
                         <td colspan="3" align="left" >  <s:property value="scenesafe.clgist"/> </td>
                          ...
                          <tr>
									<td>附件：</td>
									<td align="left" colspan="3"><s:iterator status="i" value="scenesafe.list">
											<a href="#"
												onclick="downLoad('<s:property value="uploadId"/>')"><s:property
													value="fileFileName" /></a>&nbsp;
											<br />
										</s:iterator></td>
								</tr>
							</table>
