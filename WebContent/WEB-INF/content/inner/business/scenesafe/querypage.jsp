...
<script type="text/javascript">
	...
	{ 
		...
		document.form1.action="<%=basepath%>/querscenesafeAction_querypagetj.action?prjnamee="+prjnamee+"&&prjnumm="+prjnumm;
							...
							<table width="100%" border="0" align="left" cellpadding="0"
								...
								<tr>
									...
									<td><input id="prjnamee" type="text" name="scenesafe.prjnamee"
										value="<s:property value="scenesafe.prjnamee"/>" /></td>
									<td>项目编号：</td>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<td align='center'>
						<a href="scenesafeAction_modifyPage.action?permitid=<s:property value="permitid"/>">详细</a>
						<a href="scenesafeAction_delete.action?permitid=<s:property value="permitid"/>">删除</a>
						</td>
					</tr>
				</s:iterator>
