...
<title>上报质量勘察审核历史查询</title>
<script language="javascript" src="<%=basepath%>/js/Lodop/LodopFuncs.js"></script>
<script type="text/javascript">
	//返回
	function goBack()
	{
		document.form1.action="<%=basepath%>/qualityHistoryAction_goBack.action";
...
<body>
							...
							<table class="" cellpadding="0" cellspacing="0">
								<tbody>
									...
									<tr style="height: 60px; border: 0">
										<td>审核建议：</td>
										<td colspan="3"><textarea id="appId" rows="3" cols="75"
												name="quality.appOpinion" class="required"><s:property
													value="quality.appOpinion" /></textarea></td>
									</tr>
								</tbody>
							</table>
	...
	<div id="table03" style="display: none">
		...
		<table border="1" width="100%" height="50%"
			...
			<tr>
				...
				<td width="30%" colspan="2"><p>
						&nbsp;
						<s:property value="quality.projectName" />
					</p></td>
				<td width="20%" colspan="2"><p align="center">结构/层数</p></td>
				<td width="30%" colspan="2"><p>
						&nbsp;
						<s:property value="quality.configuration" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="30%" colspan="2"><p>
						&nbsp;
						<s:property value="quality.projectAddress" />
					</p></td>
				<td width="20%" colspan="2"><p align="center">联系人</p></td>
				<td width="30%" colspan="2"><p>
						&nbsp;
						<s:property value="quality.contact" />
					</p></td>
			</tr>
			...
			<tr>
				...
				<td width="80%" colspan="6"><p>
						&nbsp;
						<s:property value="quality.constructionArea" />
						㎡
					</p></td>
			</tr>
			<tr>
				...
				<td width="80%" colspan="6"><p>
						&nbsp;
						<s:property value="quality.quantities" />
						万元
					</p></td>
			</tr>

			<tr>
				<td width="20%"><p align="center">工程总造价（万元）</p></td>
				<td width="25%"><p>
						&nbsp;
						<s:property value="quality.expensive" />
						万元
					</p></td>
				<td width="25%" colspan="3"><p align="center">监督费（元）</p></td>
				<td width="30%" colspan="2"><p>
						&nbsp;
						<s:property value="quality.superviseCost" />
						元
					</p></td>
			</tr>
			...
			<tr>
				...
				<td width="25%"><p>
						&nbsp;
						<s:date name="quality.startDate" format="yyyy-MM-dd" />
					</p></td>
				<td width="25%" colspan="3"><p align="center">计划竣工日期</p></td>
				<td width="30%" colspan="2"><p>
						&nbsp;
						<s:date name="quality.endDate" format="yyyy-MM-dd" />
					</p></td>
			</tr>

			<tr>
				<td width="20%" rowspan="2"><p align="center">建设单位</p></td>
				<td width="25%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.developmentOrganization" />
					</p></td>
				<td width="15%" rowspan="2" colspan="2"><p align="center">资质等级
					</p></td>
				<td width="10%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.developmentQualificationLevel" />
					</p></td>
				<td width="15%"><p>&nbsp;项目负责人</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.developmentCharge" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.developmentPhone" />
					</p></td>
			</tr>
			...
			<tr>
				...
				<td width="25%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.surveyUnit" />
					</p></td>
				<td width="15%" rowspan="2" colspan="2"><p align="center">资质等级
					</p></td>
				<td width="10%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.surveyUnitQualificationLevel" />
					</p></td>
				<td width="15%"><p>&nbsp;项目负责人</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.surveyUnitCharge" />
					</p></td>
			</tr>
			<tr>
				<td width="15%"><p>&nbsp;联系电话</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.surveyUnitPhone" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="25%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.designUnit" />
					</p></td>
				<td width="15%" rowspan="2" colspan="2"><p align="center">资质等级
					</p></td>
				<td width="10%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.designUnitQualificationLevel" />
					</p></td>
				<td width="15%"><p>&nbsp;项目负责人</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.designUnitCharge" />
					</p></td>
			</tr>
			<tr>
				<td width="15%"><p>&nbsp;联系电话</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.designUnitPhone" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="25%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.supervisionUnit" />
					</p></td>
				<td width="15%" rowspan="2" colspan="2"><p align="center">资质等级
					</p></td>
				<td width="10%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.supervisionUnitQualLevel" />
					</p></td>
				<td width="15%"><p>&nbsp;总监理工程师</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.supervisionUnitEngineer" />
					</p></td>
			</tr>
			<tr>
				<td width="15%"><p>&nbsp;联系电话</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.supervisionUnitPhone" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="25%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.constructionUnit" />
					</p></td>
				<td width="15%" rowspan="2" colspan="2"><p align="center">资质等级
					</p></td>
				<td width="10%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.constructionUnitQualLevel" />
					</p></td>
				<td width="15%"><p>&nbsp;项目经理</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.constructionUnitProjectManager" />
					</p></td>
			</tr>
			<tr>
				<td width="15%"><p>&nbsp;联系电话</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.constructionUnitPhone" />
					</p></td>
			</tr>
			...
			<tr>
				...
				<td width="25%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.constructionPlans" />
					</p></td>
				<td width="15%" rowspan="2" colspan="2"><p align="center">类别
					</p></td>
				<td width="10%" rowspan="2"><p>
						&nbsp;
						<s:property value="quality.constructionPlansType" />
					</p></td>
				<td width="15%"><p>&nbsp;项目负责人</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.constructionPlansCharge" />
					</p></td>
			</tr>
			<tr>
				<td width="15%"><p>&nbsp;联系电话</p></td>
				<td width="15%"><p>
						&nbsp;
						<s:property value="quality.constructionPlansPhone" />
					</p></td>
			</tr>
		</table>
		<!--  
		...
		<table border="1" width="100%" height="32%"
			...
			<tr>
				...
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.constructionContractFileNum" />
					</p></td>
				<td width="30%"><p align="center">建设单位项目负责人及项目机构组成</p></td>
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.developmentOrganFileNum" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.constructionOrganFileNum" />
					</p></td>
				<td width="30%"><p align="center">施工单位项目负责人及项目机构组成</p></td>
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.onstructionUnitFileNum" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.constructionPlansFileNum" />
					</p></td>
				<td width="30%"><p align="center">监理单位项目负责人及项目机构组成</p></td>
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.supervisionUnitFileNum" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.supervisionContractFileNum" />
					</p></td>
				<td width="30%"><p align="center">施工现场项目负责人、技术人员资格证书</p></td>
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.constructionSiteFileNum" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.supervisionPlanFileNum" />
					</p></td>
				<td width="30%"><p align="center">质量检查员岗位证书</p></td>
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.qualityTestingFileNum" />
					</p></td>
			</tr>
			<tr>
				...
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.fireControlFileNum" />
					</p></td>
				<td width="30%"><p align="center">现场监理人员注册执业证书</p></td>
				<td width="20%"><p>
						&nbsp;
						<s:property value="quality.fieldSupervisionFileNum" />
					</p></td>
			</tr>
		</table>
			-->
	...
	<script language="javascript" type="text/javascript">
		...
		function CreatePrintPageA() {
			...
			//LODOP.ADD_PRINT_TEXT(9, 628, 164, 25, "监督注册号："+document.getElementById("jianduzhuceNum").value);
			//LODOP.ADD_PRINT_TEXT(80, 627, 109, 25, "文件编号："+document.getElementById("wenjianNum").value);
		};
		...
		function CreatePrintPageB() {
			...
			//LODOP.ADD_PRINT_TEXT(13, 583, 179, 30, "监督注册号："+document.getElementById("jianduzhuceNum").value);
			//LODOP.ADD_PRINT_TEXT(41, 582, 111, 30, "文件编号 ："+document.getElementById("wenjianNum").value);
			...
			LODOP
					.ADD_PRINT_TEXT(
							...
							""
									...
									+ "    你单位建设的"
									+ document.getElementById("projectName").value
									+ "工程，我站根据《建设工程质量管理条例》、《黑龙江省建设工程质量监督管理条例》等有关规定，对所提供资料进行了审查，现准予办理工程质量监督注册手续。\n"
									...
									+ "    欢迎对我站及工作人员的工作进行监督，监督电话：________。");
			//LODOP.SET_PRINT_STYLEA(0,"LetterSpacing",3);
			LODOP.SET_PRINT_STYLEA(0, "FontSize", 15);
			LODOP.ADD_PRINT_TEXT(696, 425, 233, 96, "联系人：\n联系电话：");
			LODOP.SET_PRINT_STYLEA(0, "FontSize", 15);
			LODOP.ADD_PRINT_TEXT(847, 357, 360, 85,
					"________工程质量监督站\n    年  月  日");
			LODOP.SET_PRINT_STYLEA(0, "FontSize", 15);
			LODOP.SET_PRINT_STYLEA(0, "LetterSpacing", 3);
		};
