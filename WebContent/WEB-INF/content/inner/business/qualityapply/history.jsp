...
<title>上报质量勘察项目审核历史查询</title>
<script type="text/javascript">
	//查询
	function query()
	{
		document.form1.action="<%=basepath%>/qualityHistoryAction_queryHistoryPage.action";
		...
		<form id="form1" name="form1" method="post" action="">
			<table width="100%" border="0" cellpadding="0" height="15%">
				<tr>
					<td>
						<fieldset>
							<legend class="chaxuntj">质量勘察审核历史查询</legend>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<td align='center'><a
							href="qualityHistoryAction_queryHistory.action?qualityId=<s:property value="qualityId"/>">详细</a>
						</td>
					</tr>
				</s:iterator>
