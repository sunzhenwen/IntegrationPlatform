...
function downLoad(uploadId)
{
	...
	function applythrough()
	{
		...
		if(nm.value != "")
		{
			document.form1.action="<%=basepath%>/designFilingApplyAction_approvalSuccess.action";
			document.form1.submit();
		}else
		{
			alert("请输入备案意见!");	
	...
	function applyBack()
	{
		...
		if(nmv.value != "")
		{
			document.form1.action="<%=basepath%>/designFilingApplyAction_approvalFailed.action";
			document.form1.submit();
		}else
		{
			alert("请输入备案意见!");	
	...
	function goBack()
	{
		document.form1.action="<%=basepath%>/designFilingApplyAction_goBack.action";
		document.form1.submit();
	}
...
<body>
	<div class="qy_wrapp">
		...
		<div class="sp_main">
			...
			<h2 class="f16 fb" style="background: #80aced;">设计合同备案</h2>
