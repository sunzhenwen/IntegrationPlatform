...
<title>上报合同备案审查审核历史查询</title>
<script language="javascript" src="<%=basepath%>/js/Lodop/LodopFuncs.js"></script>
<script type="text/javascript">
	//返回
	function goBack()
	{
		document.form1.action="<%=basepath%>/filingHistoryAction_goBack.action";
	...
	{
		window.open('<%=basepath %>/filingBusinessAction_queryPage.action?type=1&conId='+recordId)   
	}
...
<body>
	<div class="qy_wrapp">
		...
		<div class="sp_main">
			...
			<h2 class="f16 fb" style="background: #80aced;">合同备案历史查询</h2>
			<form style="margin: 50px;" id="form1" name="form1" method="post"
				...
				<table class="sp_mtable" style="border-collapse: collapse;"
					...
					<tr>
						<td>备案单位：</td>
						<td><s:property value="filing.appSteffName" /></td>
						<td>备案时间：</td>
						<td><s:date name="filing.appDate" format="yyyy-MM-dd" /></td>
					</tr>
					<tr>
						<td>合同编号：</td>
						<td><s:property value="filing.contractNum" /></td>
						<td>合同：</td>
						<td ><a href="#" onclick="getCertification('<s:property value="filing.recordId"/>')">详细查看</a></td>
					</tr>
					<tr style="height: 60px; border: 0">
						<td>备案结果：</td>
						<td>
							<s:if test="filing.appType==0">待审核</s:if>
							<s:if test="filing.appType==1">备案通过</s:if>
							<s:if test="filing.appType==2">备案不通过</s:if>
						</td>
						<td>备案意见：</td>
						<td colspan="3"><textarea id="appId"
								name="filing.appOpinion" class="required"><s:property
									value="filing.appOpinion" /></textarea></td>
					</tr>
...
<table border="1" width="100%" height="90%" style="border:solid 1px black;border-collapse:collapse">
  ...
  <tr>
    ...
    <td width="80%" colspan="3" ><p align="center"><s:property value="filing.recordNum" /> </p></td>
  </tr>
   <tr>
    <td width="20%" ><p align="center">项目名称 </p></td>
    <td width="80%" colspan="3" ><p align="center"><s:property value="filing.prjName" /></p></td>
  </tr>
  <tr>
    <td width="20%" ><p align="center">项目编号 </p></td>
    <td width="80%" colspan="3" ><p align="center"><s:property value="filing.prjNum" /></p></td>
  </tr>
  <tr>
    <td width="20%" ><p align="center">合同编号 </p></td>
    <td width="80%" colspan="3" ><p align="center"> <s:property value="filing.contractNum" /></p></td>
  </tr>
  <tr>
    <td width="20%" ><p align="center">合同类别 </p></td>
    <td width="80%" colspan="3" ><p align="center"><s:property value="filing.contractTypeName" /></p></td>
  </tr>
  			
    <tr>
    <td width="20%" ><p align="center">合同金额（万元） </p></td>
    <td width="80%" colspan="3" ><p align="center"><s:property value="filing.contractMoney" /></p></td>
  </tr>			
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="80%" colspan="3" ><p align="center"> <s:date name="filing.contractDate" format="yyyy-MM-dd" /></p></td>
  </tr>		 		 
  <tr>
    <td width="20%" ><p align="center"> 发包单位名称</p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="filing.propietorCorpName" /></p></td>
  </tr>	
  
  <tr>
    <td width="20%" ><p align="center"> 承包单位名称</p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="filing.contractorCorpName" /></p></td>
  </tr>
  
  <tr>
    <td width="20%" ><p align="center"> 联合体承包单位名称</p></td>
    <td width="80%" colspan="3" ><p align="center">&nbsp; <s:property value="filing.unionCorpName" /></p></td>
  </tr>	 	  
