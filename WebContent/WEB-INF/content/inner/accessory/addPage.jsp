...
<body>
	...
	<div class="qy_wrapp">
		...
		<div class="sp_main">
			...
			<h2 class="f16 fb" style="background: #3874d3;">新增附件信息</h2>
			<form style="margin: 50px;" id="form1" name="form1" method="post"
				action="<%=basepath%>/accessoryAction_addMethod.action"
				...
				<table class="sp_mtable" style="border-collapse: collapse;"
					...
					<tr>
						<td>显示序号：</td>
						<td>
						<input type="text" maxlength='200' name="accessory.num" class="required number" /><strong><font color="#FF0000">*</font></strong>
						</td>
						<td>环节选择：</td>
						<td>
					...
					<tr>
						<td>附件信息提示信息：</td>
						<td colspan="3">
						<input type="text" size="80" maxlength='200' name="accessory.message" class="required" /><strong><font color="#FF0000">*</font></strong>
						</td>
					</tr>
				</table>
				<div class="sp_bton">
