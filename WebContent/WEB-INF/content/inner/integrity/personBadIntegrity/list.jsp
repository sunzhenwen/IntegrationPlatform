...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath %>/personBadIntegrityAction_queryPage.action";
		document.form1.submit();
	}
	function queryInfo()
	{
		document.form1.action="<%=basepath%>/personBadIntegrityAction_queryInfoPage.action";
		document.form1.submit();
	}
        	...
        	<div class="ry_main" cellpadding="0" cellspacing="0">
                ...
                <table class="ry_right left">
                	<tr>
                        ...
                        <td><s:if test="condition.personalID == 1"><input type="image" onclick="add()" src="<%=basepath %>/images/tianjia.png" /></s:if>
                	...
                	<tbody>   
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr style="font-size: x-small;">
                            ...
                            <s:if test="condition.personalID != 1">
                            <a href="personBadIntegrityAction_detail.action?badPersonId=<s:property value="badPersonId"/>"><span class="lbmingx">详细</span></a>
                            </s:if>
                            </td>
                         </tr>
						</s:iterator>
