...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath%>/corpGoodIntegrityAction_queryPage.action";
		document.form1.submit();
	}
	function queryInfo()
	{
		document.form1.action="<%=basepath%>/corpGoodIntegrityAction_queryInfoPage.action";
		document.form1.submit();
	}
	...
	function add()
	{
		document.form1.action="<%=basepath%>/corpGoodIntegrityAction_addPage.action";
		document.form1.submit();
	}
		...
		<form id="form1" name="form1" method="post" action="">
			...
			<div class="ry_content">
					...
					<div class="ry_main" cellpadding="0" cellspacing="0">
						...
						<table class="ry_right left">
							<tr>
								...
								<td><s:if test="condition.personalID == 1">
										<input type="image" onclick="add()"
											src="<%=basepath%>/images/tianjia.png" />
									</s:if>
				...
				<div class="ry_liebiao">
					<p class="f16 fb">
						企业良好行为信息列表<img src="<%=basepath%>/images/ry_lie.png" />
					</p>
					<table class="" cellpadding="0" cellspacing="0">
						<tbody>
							...
							已发布
									...
									<td align='center'><s:if test="condition.personalID == 1">
											<a
												href="corpGoodIntegrityAction_modifyPage.action?corpGoodCreditId=<s:property value="corpGoodCreditId"/>"><span
												class="lbmingx">修改</span></a>&nbsp;&nbsp;<a
												href="corpGoodIntegrityAction_deleteGoodInfo.action?corpGoodCreditId=<s:property value="corpGoodCreditId"/>"><span
												class="lbmingx">删除</span></a>
										</s:if> <s:if test="condition.personalID != 1">
											<a
												href="corpGoodIntegrityAction_detailPage.action?corpGoodCreditId=<s:property value="corpGoodCreditId"/>"><span
