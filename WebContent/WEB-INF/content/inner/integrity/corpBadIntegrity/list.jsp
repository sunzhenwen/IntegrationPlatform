...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath %>/corpBadIntegrityAction_queryPage.action";
		document.form1.submit();
	}
	function queryInfo()
	{
		document.form1.action="<%=basepath%>/corpBadIntegrityAction_queryInfoPage.action";
		document.form1.submit();
	}
                	...
                	<tbody>   
                         ...
                         <s:iterator status="i" value="currentPage.data" > 
                          <tr style="font-size: x-small;">
                            ...
                            <s:if test="condition.personalID != 1">
                            <a href="corpBadIntegrityAction_detail.action?corpBadCreditId=<s:property value="corpBadCreditId"/>"><span class="lbmingx">详细</span></a>
                            </s:if>
                            </td>
                         </tr>
						</s:iterator>
