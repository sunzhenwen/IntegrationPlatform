...
<script type="text/javascript">
	...
	function queryInfo()
	{
		document.form1.action="<%=basepath%>/personGoodIntegrityAction_queryInfoPage.action";
		document.form1.submit();
	}
					...
					<table class="" cellpadding="0" cellspacing="0">
						<tbody>
							...
							已发布
									...
									<s:if test='condition.personalID!=1'><a href="personGoodIntegrityAction_detailPage.action?goodCreditId=<s:property value="goodCreditId"/>"><span
