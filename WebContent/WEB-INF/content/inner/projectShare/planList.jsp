...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath%>/planShareAction_queryPage.action";
		...
		<form id="form1" name="form1" method="post" action="">
			<table width="100%" border="0" cellpadding="0" height="15%">
				<tr>
					<td>
						<fieldset>
							<legend class="chaxuntj">施工图审查共享查询</legend>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<td align='center'><a
							href="planShareAction_queryInfo.action?censorId=<s:property value="censorId"/>">详细</a>
						</td>
					</tr>
				</s:iterator>
