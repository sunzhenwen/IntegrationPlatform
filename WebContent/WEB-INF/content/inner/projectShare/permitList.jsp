...
<script type="text/javascript">
	...
	function query()
	{
		document.form1.action="<%=basepath%>/promiseShareAction_queryPage.action";
	...
	function queryArea() {
		$(document).ready(
			function() {
				...
				$.ajax({
					url : 'promiseShareAction_queryApprovaArea.action',
					type : 'post',
					dataType : 'json',
		...
		<form id="form1" name="form1" method="post" action="">
			<table width="100%" border="0" cellpadding="0" height="15%">
				<tr>
					<td>
						<fieldset>
							<legend class="chaxuntj">施工许可共享查询</legend>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<s:iterator status="i" value="currentPage.data">
					<tr>
						...
						<td align='center'><a
							href="promiseShareAction_queryInfo.action?permitId=<s:property value="permitId"/>">详细 </a>
						</td>
					</tr>
				</s:iterator>
