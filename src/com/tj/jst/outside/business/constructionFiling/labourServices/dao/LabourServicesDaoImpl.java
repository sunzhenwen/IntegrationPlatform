package com.tj.jst.outside.business.constructionFiling.labourServices.dao;
 ...
 *
 */
public class LabourServicesDaoImpl extends BaseDao implements ILabourServicesDao {
	...
	public ContractFiling queryById(String recordId)
	{
		...
		try {
			...
			pstmt = conn.prepareStatement("select * from v_ACCESSORY_linkname where linkNum=13 order by num");
			rs = pstmt.executeQuery();
