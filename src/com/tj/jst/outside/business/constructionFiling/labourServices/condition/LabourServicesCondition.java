package com.tj.jst.outside.business.constructionFiling.labourServices.condition;
 ...
 *
 */
public class LabourServicesCondition extends Condition {
	...
	public LabourServicesCondition()
	{
		
	}
	
	public LabourServicesCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where trim(processSteps)=3 and contrType='4' and contractTypeNum='303' ");
