 ...
 *
 */
public class TheContractorTenderInfoCondition extends Condition {
	...
	public TheContractorTenderInfoCondition()
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where prjNum='"+this.getPrjNum()+"' and tenderclassnum='003' ");
