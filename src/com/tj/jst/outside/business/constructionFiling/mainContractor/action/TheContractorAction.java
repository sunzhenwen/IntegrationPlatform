...
import com.tj.jst.outside.business.constructionFiling.mainContractor.condition.TheContractorCondition;
 ...
 *
 */
public class TheContractorAction extends BaseAction {
	...
	private TheContractorCondition condition = new TheContractorCondition();
	
	public void setCondition(TheContractorCondition condition) {
		this.condition = condition;
	}

	public TheContractorCondition getCondition() {
		TheContractorCondition sessionCondition = (TheContractorCondition) get(getActionName());
