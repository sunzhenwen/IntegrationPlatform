 ...
 *
 */
public class TheContractorCondition extends Condition {
	...
	public TheContractorCondition()
	{
		
	}
	
	public TheContractorCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where trim(processSteps)=3 and contrType='1' and contractTypeNum='301' ");
