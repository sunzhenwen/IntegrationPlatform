package com.tj.jst.outside.business.survey.condition;
 ...
 *
 */
public class DesignSurveyPrjsCondition extends Condition {
	...
	public DesignSurveyPrjsCondition()
	{
		
	}
	
	public DesignSurveyPrjsCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where TO_NUMBER(trim(processSteps))>=2 and appType=1 ");
		...
		if(corpCode!= null && !"".equals(corpCode)){
			sb.append(" and BUILDCORPCODE like '%"+corpCode.trim()+"%'"); 
		}
