 ...
 *
 */
public class SurveyCondition extends Condition {
	...
	public SurveyCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where trim(processSteps)=2 ");
	...
	public String getCountSql() {
		...
		String sqlCount="select count(*) from survey_BUSINESS "+sb.toString();
		return sqlCount;
	}
