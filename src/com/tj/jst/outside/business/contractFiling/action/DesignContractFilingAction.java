...
import com.tj.jst.outside.business.contractFiling.condition.DesignContractFilingCondition;
 ...
 *
 */
public class DesignContractFilingAction extends BaseAction {
	...
	private DesignContractFilingCondition condition = new DesignContractFilingCondition();
	
	public void setCondition(DesignContractFilingCondition condition) {
		this.condition = condition;
	}

	public DesignContractFilingCondition getCondition() {
		DesignContractFilingCondition sessionCondition = (DesignContractFilingCondition) get(getActionName());
