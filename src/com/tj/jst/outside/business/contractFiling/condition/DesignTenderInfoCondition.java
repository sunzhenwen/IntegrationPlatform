 ...
 *
 */
public class DesignTenderInfoCondition extends Condition {
	...
	public DesignTenderInfoCondition()
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where prjNum='"+this.getPrjNum()+"' and tenderclassnum='002' ");
