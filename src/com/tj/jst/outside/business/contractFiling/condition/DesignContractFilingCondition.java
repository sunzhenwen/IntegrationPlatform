 ...
 *
 */
public class DesignContractFilingCondition extends Condition {
	...
	public DesignContractFilingCondition()
	{
		
	}
	
	public DesignContractFilingCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where trim(processSteps)=3 and contractTypeNum='200' ");
