 ...
 *
 */
public class CompleteCondition extends Condition {
	...
	public CompleteCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where trim(processSteps)=6 ");
	...
	public String getCountSql() {
		...
		String sqlCount="select count(*) from TBPROJECTFINISHMANAGE "+sb.toString();
		return sqlCount;
	}
