 ...
 *
 */
public class QualityPrjsCondition extends Condition {
	...
	public QualityPrjsCondition()
	{
		
	}
	
	public QualityPrjsCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where TO_NUMBER(trim(processSteps))>=4 and AUCORPCODE='"+this.getCorpCode()+"' ");
