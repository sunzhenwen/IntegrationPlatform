 ...
 *
 */
public class QualitysjCondition extends Condition {
	...
	public QualitysjCondition()
	{	
	}
	
	public QualitysjCondition(String prjNum)
	{
		this.prjNum = prjNum;
	}
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where CONTRACTTYPENUM=200 and TO_NUMBER(trim(processSteps))>=3 and prjNum='"+this.getPrjNum()+"' ");
