package com.tj.jst.outside.business.construction.condition;
 ...
 *
 */
public class ConstructionCondition extends Condition {
	...
	public ConstructionCondition()
	{
		
	}
	
	public ConstructionCondition(String corpCode)
	{
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where processSteps=1 ");
