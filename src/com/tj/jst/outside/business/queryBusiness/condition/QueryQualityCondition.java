 ...
 *
 */
public class QueryQualityCondition extends Condition {
	...
	public QueryQualityCondition()
	{
		
	}
	
	public QueryQualityCondition(String corpCode)
	{
...
//		}
		...
		String sql = "select * from v_au_tbq "+sb.toString();
		return sql;
	}
...
//			sb.append(" and APPLYCORPCODE='"+corpCode.trim()+"'"); 
//		}
		String sqlCount="select count(*) from v_au_tbq "+sb.toString();
		return sqlCount;
	}
