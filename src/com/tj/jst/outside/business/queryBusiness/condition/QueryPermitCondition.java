 ...
 *
 */
public class QueryPermitCondition extends Condition {
	...
	public QueryPermitCondition()
	{
		
	}
	
	public QueryPermitCondition(String corpCode)
	{
...
//		}
		...
		String sql = "select * from v_au_tbbuilderlicencemanage "+sb.toString();
		return sql;
	}
...
//			sb.append(" and APPLYCORPCODE='"+corpCode.trim()+"'"); 
//		}
		String sqlCount="select count(*) from v_au_tbbuilderlicencemanage "+sb.toString();
		return sqlCount;
	}
