 ...
 *
 */
public class QuerySafetyCondition extends Condition {
	...
	public QuerySafetyCondition()
	{
		
	}
	
	public QuerySafetyCondition(String corpCode)
	{
...
//		}
		...
		String sql = "select * from v_au_tbs "+sb.toString();
		return sql;
	}
...
//			sb.append(" and APPLYCORPCODE='"+corpCode.trim()+"'"); 
//		}
		String sqlCount="select count(*) from v_au_tbs "+sb.toString();
		return sqlCount;
	}
