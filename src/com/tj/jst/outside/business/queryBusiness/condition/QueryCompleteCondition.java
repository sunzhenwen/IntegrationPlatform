 ...
 *
 */
public class QueryCompleteCondition extends Condition {
	...
	public QueryCompleteCondition()
	{
		
	}
	
	public QueryCompleteCondition(String corpCode)
	{
...
//		}
		...
		String sql = "select * from v_au_TBPRJECTFINISHMANAGE "+sb.toString();
		return sql;
	}
...
//			sb.append(" and APPLYCORPCODE='"+corpCode.trim()+"'"); 
//		}
		String sqlCount="select count(*) from v_au_TBPRJECTFINISHMANAGE "+sb.toString();
		return sqlCount;
	}
