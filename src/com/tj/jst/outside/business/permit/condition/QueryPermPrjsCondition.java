 ...
 *
 */
public class QueryPermPrjsCondition extends Condition {
	...
	public String getInitialSql() {
		...
		//查询当前可用单位；
		StringBuffer sb=new StringBuffer(" where TO_NUMBER(trim(processSteps))>=5 and AUCORPCODE='"+this.getCorpCode()+"' ");
