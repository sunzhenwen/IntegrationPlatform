 ...
 *
 */
public class QueryPermSafetyCondition extends Condition {
	...
	public QueryPermSafetyCondition()
	{
	...
	public String getCountSql() {
		...
		String sqlCount="select count(*) from TB_SAFETYSUPERVISION "+sb.toString();
		return sqlCount;
	}
