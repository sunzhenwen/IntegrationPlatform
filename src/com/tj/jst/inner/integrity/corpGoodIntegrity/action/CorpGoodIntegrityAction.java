package com.tj.jst.inner.integrity.corpGoodIntegrity.action;
...
public class CorpGoodIntegrityAction extends BaseAction {
	...
	private CorpGoodIntegrityCondition condition = new CorpGoodIntegrityCondition(
			((Login) this.get("login")).getDepartmentID());

	public void setCondition(CorpGoodIntegrityCondition condition) {
		this.condition = condition;
	}

	public CorpGoodIntegrityCondition getCondition() {
		CorpGoodIntegrityCondition sessionCondition = (CorpGoodIntegrityCondition) get(getActionName());
	...
	public String queryPage() {
		ICorpGoodIntegrityService dao = new CorpGoodIntegrityServiceImpl();
