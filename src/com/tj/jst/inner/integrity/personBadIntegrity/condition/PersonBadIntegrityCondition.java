package com.tj.jst.inner.integrity.personBadIntegrity.condition;
 ...
 *
 */
public class PersonBadIntegrityCondition extends Condition {
	...
	public PersonBadIntegrityCondition()
	{
		
	}
	
	public PersonBadIntegrityCondition(String deptId)
	{
		this.deptId = deptId;
	}
