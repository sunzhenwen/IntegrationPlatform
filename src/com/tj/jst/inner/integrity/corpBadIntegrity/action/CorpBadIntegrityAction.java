package com.tj.jst.inner.integrity.corpBadIntegrity.action;
 ...
 *
 */
public class CorpBadIntegrityAction extends BaseAction {
	...
	private CorpBadIntegrityCondition condition = new CorpBadIntegrityCondition(((Login)this.get("login")).getDepartmentID());
	
	public void setCondition(CorpBadIntegrityCondition condition) {
		this.condition = condition;
	}

	public CorpBadIntegrityCondition getCondition() {
		CorpBadIntegrityCondition sessionCondition = (CorpBadIntegrityCondition) get(getActionName());
