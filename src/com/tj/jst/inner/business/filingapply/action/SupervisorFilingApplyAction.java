...
import com.tj.jst.inner.business.filingapply.condition.SupervisorFilingApplyCondition;
 ...
 *
 */
public class SupervisorFilingApplyAction extends BaseAction {
	...
	private SupervisorFilingApplyCondition condition = new SupervisorFilingApplyCondition(
			((Login) this.get("login")).getDepartmentID());

	public void setCondition(SupervisorFilingApplyCondition condition) {
		this.condition = condition;
	}

	public SupervisorFilingApplyCondition getCondition() {
		SupervisorFilingApplyCondition sessionCondition = (SupervisorFilingApplyCondition) get(getActionName());
