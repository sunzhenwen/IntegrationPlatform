...
import com.tj.jst.inner.business.filingapply.condition.DesignFilingApplyCondition;
 ...
 *
 */
public class DesignFilingApplyAction extends BaseAction {
	...
	private DesignFilingApplyCondition condition = new DesignFilingApplyCondition(
			((Login) this.get("login")).getDepartmentID());

	public void setCondition(DesignFilingApplyCondition condition) {
		this.condition = condition;
	}

	public DesignFilingApplyCondition getCondition() {
		DesignFilingApplyCondition sessionCondition = (DesignFilingApplyCondition) get(getActionName());
