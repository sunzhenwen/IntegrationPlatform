 ...
 *
 */
public class ConstructionFilingApplyCondition extends Condition {
	...
	public ConstructionFilingApplyCondition(String appDept) {
	...
	public String getInitialSql() {
		...
		StringBuffer sb = new StringBuffer(
				" where trim(processSteps)=3 and trim(appType)=0 and APPDEPT = '"+ appDept + "' and (trim(CONTRACTTYPENUM)=301 or trim(CONTRACTTYPENUM)=302 or trim(CONTRACTTYPENUM)=303) ");
