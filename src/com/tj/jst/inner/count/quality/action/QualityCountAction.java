package com.tj.jst.inner.count.quality.action;
...
import com.tj.jst.inner.count.quality.service.IQualityCountService;
import com.tj.jst.inner.count.quality.service.QualityCountServiceImpl;
 ...
 *
 */
public class QualityCountAction extends BaseAction {
	...
	public String queryPage() {
		...
		IQualityCountService service = new QualityCountServiceImpl();
		// 查询地市下拉列表数据
