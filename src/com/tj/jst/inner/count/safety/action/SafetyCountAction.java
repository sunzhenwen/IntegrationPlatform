package com.tj.jst.inner.count.safety.action;
...
import com.tj.jst.inner.count.safety.service.ISafetyCountService;
import com.tj.jst.inner.count.safety.service.SafetyCountServiceImpl;
 ...
 *
 */
public class SafetyCountAction extends BaseAction {
	...
	public String queryPage() {
		...
		ISafetyCountService service = new SafetyCountServiceImpl();
		// 查询地市下拉列表数据
