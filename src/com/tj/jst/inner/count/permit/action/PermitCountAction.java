package com.tj.jst.inner.count.permit.action;
...
import com.tj.jst.inner.count.permit.service.IPermitCountService;
import com.tj.jst.inner.count.permit.service.PermitCountServiceImpl;
 ...
 *
 */
public class PermitCountAction extends BaseAction {
	...
	public String queryPage() {
		...
		IPermitCountService service = new PermitCountServiceImpl();
		// 查询地市下拉列表数据
