...
import com.tj.jst.inner.statistics.service.ConstructionStatisticsServiceImpl;
import com.tj.jst.inner.statistics.service.IConstructionStatisticsService;
 ...
 *
 */
public class ConstructionStatisticsAction extends BaseAction {
	...
	{
		IConstructionStatisticsService service = new ConstructionStatisticsServiceImpl();
		//查询地市下拉列表数据
