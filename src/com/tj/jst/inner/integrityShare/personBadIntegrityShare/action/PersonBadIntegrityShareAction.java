package com.tj.jst.inner.integrityShare.personBadIntegrityShare.action;
...
import com.tj.jst.inner.integrityShare.personBadIntegrityShare.condition.PersonBadIntegrityShareCondition;
import com.tj.jst.inner.integrityShare.personBadIntegrityShare.service.IPersonBadIntegrityShareService;
import com.tj.jst.inner.integrityShare.personBadIntegrityShare.service.PersonBadIntegrityShareServiceImpl;
 ...
 *
 */
public class PersonBadIntegrityShareAction extends BaseAction {
	...
	private PersonBadIntegrityShareCondition condition = new PersonBadIntegrityShareCondition(((Login)this.get("login")).getDepartmentID());
	
	public void setCondition(PersonBadIntegrityShareCondition condition) {
		this.condition = condition;
	}

	public PersonBadIntegrityShareCondition getCondition() {
		PersonBadIntegrityShareCondition sessionCondition = (PersonBadIntegrityShareCondition) get(getActionName());
	...
	{
		IPersonBadIntegrityShareService service = new PersonBadIntegrityShareServiceImpl();
